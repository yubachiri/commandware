...
class CommandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create command" do
    assert_difference('Command.count') do
      post commands_url, params: { command: { command: @command.command, description: @command.description, name: @command.name } }
    end
  ...
  test "should update command" do
    patch command_url(@command), params: { command: { command: @command.command, description: @command.description, name: @command.name } }
